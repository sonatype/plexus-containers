...
public class XStreamTool
{
    ...
    public XStreamTool()
    {
        ...
        xstream.registerConverter( new PlexusConfigurationConverter() );
    }
    ...
    public Object build( PlexusConfiguration configuration, Class clazz )
        throws Exception
    {
        PlexusConfigurationReader reader = new PlexusConfigurationReader( configuration );
    ...
    public DefaultPlexusConfiguration write( Object o )
        throws Exception
    {
        PlexusConfigurationWriter writer = new PlexusConfigurationWriter();

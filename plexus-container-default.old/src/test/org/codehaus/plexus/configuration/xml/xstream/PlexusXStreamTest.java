...
import org.codehaus.plexus.configuration.xml.xstream.Message;
import org.codehaus.plexus.configuration.xml.xstream.Summary;
import org.codehaus.plexus.configuration.xml.xstream.Element;
import org.codehaus.plexus.configuration.xml.xstream.Person;
 ...
 * @version $Id$
 */
public class PlexusXStreamTest
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        XmlPlexusConfiguration cc = builder.write( message );

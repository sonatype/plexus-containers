package org.codehaus.plexus.javadoc.stubs;
    ...
    extends MavenProjectStub
{
    ...
    public DefaultMavenProjectStub()
    {
        ...
        try
        {
            model = pomReader.read( new FileReader( new File( getBasedir(), "plexus-plugin-config.xml" ) ) );
            setModel( model );
        }
        catch ( Exception e )
        {
        ...
        build.setDirectory( super.getBasedir() + "/target/test/unit/plexus/target" );
        setBuild( build );
    ...
    {
        return new File( super.getBasedir() + "/src/test/resources/unit/plexus" );
    }
}
